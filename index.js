...
function handleEnterKey(event) {
  ...
  function calculatePromotion() {
    var productPrice = document.getElementById("price").valueAsNumber;
    var resultElement = document.getElementById("result");
    var promotionRate = 6.4;
    var calculatedPrice = (productPrice / promotionRate).toFixed(2);

    resultElement.textContent =
      "Promotion អត្រាប្តូរប្រាក់ពិសេសទៅដល់ 6.7¥ ចាប់ពីថ្ងៃទី 7 រហូតដល់ 31 មករា 2024" + "\n" +
      "\nសួស្តីបង សរុបហាងទំនិញទាំងអស់" + "￥" + productPrice +
      " ចែក 6.4 $" + calculatedPrice +  + "\n***បញ្ជាក់: ចំពោះទំនិញទិញក្នុងហាងតែមួយ ប្រសិនខាងហាងបំបែកកញ្ចប់ទំនិញ ខាងប្អូននឹងរាប់កញ្ចប់ទំនិញគិតថ្លៃដឹកតាមចំនួនកញ្ចប់ទំនិញដូចគ្នា សំរាប់កញ្ចប់ដែលក្រោម1គីឡូ ខាងប្អូនគិតមួយគីឡូ លើស1គីឡូយក ទំហំនិង ទម្ងង់ប្រៀបធៀបគ្នាមួយណាធំជាងយកមួយនឹងជាគោលគិតថ្លៃដឹកជញ្ចូន" + "\n" + "\nចំពោះសេវាជួយទិញគឺមិនមានការបង្រួមកញ្ចប់ទំនិញទេបង";
      
    // Additional information or notes can be added here if needed.
  }
